...
function init_mdnw() {
	...
	register_sidebar( array(
		...
		'description' => __( 'Default widget area for posts/pages... 5 grid cols wide.', 'skeleton' ),
	...
	/* Register Sidebar (Right side, next to posts/pages) */
	register_sidebar( array(
		'name' => __( 'Bottom Left-Rail Sidebar', 'skeleton' ),
		'id' => 'bottom-left-rail',
		'description' => __( 'Blog Left-Rail Sidebar for the 3-col Blog... 2 grid cols wide. ', 'skeleton' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '<hr class="partial-bottom" /></div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	...
	/* Register Sidebar (Right side, next to posts/pages) */
	register_sidebar( array(
		'name' => __( 'Bottom Right-Rail Sidebar', 'skeleton' ),
		'id' => 'bottom-right-rail',
		'description' => __( 'Blog Right-Rail Sidebar for the 3-col Blog... 3 grid cols wide.', 'skeleton' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '<hr class="partial-bottom" /></div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
