...
<?php if(get_option_tree('frontpage_featurerow') == 'No' ) { } else { ?>
	...
	<div class="container">		
		...
		<div class="one-third column">				
			<div class="module">						
				...
				<div class="module-meta">
					<h4><a href="<?php echo get_option_tree('homepage_blurb_1_url'); ?>"><?php echo get_option_tree('homepage_blurb_1_title'); ?></a></h4>	
		...
		<div class="one-third column">				
			<div class="module">
				...
				<?php } else {} ?>
				<div class="module-meta">
					<h4><a href="<?php echo get_option_tree('homepage_blurb_2_url'); ?>"><?php echo get_option_tree('homepage_blurb_2_title'); ?></a></h4>	
		...
		<div class="one-third column">				
			<div class="module">	
				...
				<?php } else {} ?>
				<div class="module-meta">
					<h4><a href="<?php echo get_option_tree('homepage_blurb_3_url'); ?>"><?php echo get_option_tree('homepage_blurb_3_title'); ?></a></h4>	
